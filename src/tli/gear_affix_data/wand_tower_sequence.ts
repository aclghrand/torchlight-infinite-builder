...
export const WAND_TOWER_SEQUENCE_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Advanced",
    "tier": "",
    "template": "Adds 200- 220Cold Damage to Spells when having at least 800Intelligence",
    "valueRanges": [],
    "rawAffix": "Adds `200`- `220`Cold Damage to Spells when having at least `800`Intelligence"
  },
  {
    "equipmentTypeKey": "wand",
    "equipmentSlot": "One-Handed",
...
export type WandTowerSequenceAffix = (typeof WAND_TOWER_SEQUENCE_AFFIXES)[number];
