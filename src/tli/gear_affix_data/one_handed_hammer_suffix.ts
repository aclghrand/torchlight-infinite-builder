...
export const ONE_HANDED_HAMMER_SUFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "rawAffix": "`+(64-74)`% additional Attack Damage after standing still for 0.1s. `-20`% additional Attack Speed"
  },
  {
    "equipmentTypeKey": "one_handed_hammer",
    "equipmentSlot": "One-Handed",
  ...
  },
  {
    ...
    "rawAffix": "`+(55-63)`% additional Attack Damage after standing still for 0.1s. `-20`% additional Attack Speed"
  },
  {
    "equipmentTypeKey": "one_handed_hammer",
    "equipmentSlot": "One-Handed",
...
export type OneHandedHammerSuffixAffix = (typeof ONE_HANDED_HAMMER_SUFFIX_AFFIXES)[number];
